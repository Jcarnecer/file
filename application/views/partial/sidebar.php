...
<div id="sidebar" style="overflow-y: auto;">
    <div id="nav-icon-back">
        <a href="<?= ENVIRONMENT === 'development' ? 'https://localhost/main' : 'https://payakapps.com' ?>">
            ...
            <a class="" href="
            	<?php
            		if(ENVIRONMENT==="development") {
                        echo "https://localhost/task/personal";
                    } else {
            ...
            <ul class="navbar-nav flex-row ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="<?= ENVIRONMENT === "development" ? 'https://localhost/main/users/profile' : 'https://payakapps.com/users/profile' ?>">My Profile</a>
                        <a class="dropdown-item" href="<?= ENVIRONMENT === "development" ? 'https://localhost/main/users/profile/change-password' : 'https://payakapps.com/users/profile/change-password' ?>">My Password</a>
    ...
    <div class="inner-content d-flex flex-column p-0">
        <ul class="nav nav-tabs d-flex flex-nowrap project-buttons">
            <li class="nav-item w-100">
                <a href="<?= ENVIRONMENT === 'development' ? 'https://localhost/task/project/' . $project['id'] : 'https://task.payakapps.com/project/' . $project['id'] ?>" class="nav-link project-button" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-tasks"></i> Tasks</a>
            </li>
            <li class="nav-item w-100">
                <a href="<?= ENVIRONMENT === 'development' ? 'https://localhost/forum/project/' . $project['id'] : 'https://forum.payakapps.com/project/' . $project['id'] ?>" class="nav-link secondary-button"><i class="fa fa-exchange-alt"></i> Discussion</a>
            </li>
            <li class="nav-item w-100">
